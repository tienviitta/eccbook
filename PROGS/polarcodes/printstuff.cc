...
static int getdoprintvalue(void) { return doprint; }

static void setdoprintvalue(int printvalue) { doprint = printvalue; }

static void setprintmatlabform(int matlabform) { printmatlabform = matlabform; }
